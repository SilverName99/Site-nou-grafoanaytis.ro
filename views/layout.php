...
$mobileMenuLogoPath = '/uploads/gallery/grafoanaytis-logo.png';
...
$siteBaseTitle = trim((string) ($designSettings['store_name'] ?? 'Grafoanaytis'));
if ($siteBaseTitle === '') {
    $siteBaseTitle = 'Grafoanaytis';
}
...
if (trim($designHeaderOutput) !== '' && preg_match($mobileMenuTokenPattern, $designHeaderOutput) === 1) {
    ...
    $mobileMenuTokenMarkup = '<div class="bv-mobile-menu-token" data-bv-mobile-menu>'
        ...
        . '<img src="' . htmlspecialchars($mobileMenuLogoPath, ENT_QUOTES) . '" alt="Grafoanaytis" loading="lazy">'
        . '</a>'
    ...
    <?php else: ?>
        <header class="header">
            <div class="container site-container header-inner">
                <a href="/" class="logo">Grafoanaytis</a>
                <nav class="nav">
