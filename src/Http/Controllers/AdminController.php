...
final class AdminController
{
    ...
    public function orderPaymentLinkSend(array $params): void
    {
        ...
        $magazin = trim((string) ($settings['order_email_from_name'] ?? 'Grafoanaytis')) ?: 'Grafoanaytis';
    ...
    public function emailsSave(): void
    {
        ...
        if ($section === 'newsletter-ecommerce-send-test') {
            ...
            try {
                OrderMailer::sendTemplate($templateType, [
                    ...
                    'customer_email' => $to,
                    'store_name' => (string) ($testSettings['order_email_from_name'] ?? 'Grafoanaytis'),
        ...
        $payload = [
            ...
            'order_email_from_name' => trim((string) ($_POST['order_email_from_name'] ?? 'Grafoanaytis')),
    ...
    private function loadBlogPostsPreview(?PDO $db, int $limit = 6): array
    {
        if (!$db instanceof PDO) {
            return [[
                ...
                'author_name' => 'Echipa Grafoanaytis',
            ]];
        }
